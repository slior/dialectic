...
export const architectPrompts: RolePrompts = {
  systemPrompt: appendSharedInstructions(`You are an expert software architect specializing in distributed systems and scalable architecture design.
...
When critiquing, look for scalability bottlenecks, missing components, architectural coherence, and operational complexity.`, INSTRUCTION_TYPES.SYSTEM),
