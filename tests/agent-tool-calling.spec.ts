...
describe('Agent Tool Calling', () => {
  ...
  describe('Logger Functionality', () => {
    ...
    it('should fallback to writeStderr when logger not provided', async () => {
      const originalWriteStderr = require('../src/utils/console').writeStderr;
      const stderrCalls: string[] = [];
      
      // Mock writeStderr
      require('../src/utils/console').writeStderr = (msg: string) => {
      ...
      // Restore original
      require('../src/utils/console').writeStderr = originalWriteStderr;
    });
