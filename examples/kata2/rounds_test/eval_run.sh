...
dialectic eval -c ./examples/kata2/eval_config1.json -d "$OUTPUT_DIR/all_agents_1R_no_clarify.json" -v -o "$OUTPUT_DIR/eval1_all_agents_1R_no_clarify.eval.json" -v
dialectic eval -c ./examples/kata2/eval_config1.json -d "$OUTPUT_DIR/all_agents_2R_no_clarify.json" -v -o "$OUTPUT_DIR/eval1_all_agents_2R_no_clarify.eval.json" -v
dialectic eval -c ./examples/kata2/eval_config1.json -d "$OUTPUT_DIR/all_agents_3R_no_clarify.json" -v -o "$OUTPUT_DIR/eval1_all_agents_3R_no_clarify.eval.json" -v
dialectic eval -c ./examples/kata2/eval_config1.json -d "$OUTPUT_DIR/all_agents_4R_no_clarify.json" -v -o "$OUTPUT_DIR/eval1_all_agents_4R_no_clarify.eval.json" -v
dialectic eval -c ./examples/kata2/eval_config1.json -d "$OUTPUT_DIR/all_agents_5R_no_clarify.json" -v -o "$OUTPUT_DIR/eval1_all_agents_5R_no_clarify.eval.json" -v